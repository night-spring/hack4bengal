        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Drop-off">Drop-off at collection center</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="mt-1 block w-full shadow-sm sm:text-sm focus:ring-green-500 focus:border-green-500 border border-gray-300 rounded-md"
          ...
          {step === 3 && (
            <div className="p-8 text-center">
              ...
              <p className="mt-2 text-gray-600">
                Thank you for providing the details. Our team will contact you soon for pickup arrangements.
              </p>
              <button
